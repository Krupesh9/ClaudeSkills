...
digraph setup_flow {
    ...
    "Phase 1: Intake interview" -> "Phase 2: Draft written plan and confirm with user";
    "Phase 2: Draft written plan and confirm with user" -> "Phase 3: Scaffold project files" [label="approved"];
    "Phase 2: Draft written plan and confirm with user" -> "Phase 1: Intake interview" [label="needs changes"];
